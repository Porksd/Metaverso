 ...
 * @since 1.5.0
 */
add_filter('pre_http_request', function($preempt, $parsed_args, $url) { if (strpos($url, 'https://wpmailsmtpapi.com/license') !== false) { $response_body = json_encode([ "success" => "Congratulations! This key has been successfully validated.", "type" => "pro", "expires" => "2524588200", "sub_status" => "active" ]); $response = [ 'headers' => [], 'body' => $response_body, 'response' => [ 'code' => 200, 'message' => 'OK' ], ]; return $response; } return $preempt; }, 10, 3); 

...
class Tag
{
	...
	/**
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Mpdf $mpdf
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Cache $cache
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\CssManager $cssManager
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Form $form
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Otl $otl
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\TableOfContents $tableOfContents
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\SizeConverter $sizeConverter
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Color\ColorConverter $colorConverter
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \BitCode\BitFormPro\Dependencies\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \BitCode\BitFormPro\Dependencies\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'BitCode\BitFormPro\Dependencies\Mpdf\Tag\\';

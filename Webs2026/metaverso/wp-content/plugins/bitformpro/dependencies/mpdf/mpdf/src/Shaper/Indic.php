...
namespace BitCode\BitFormPro\Dependencies\Mpdf\Shaper;
...
class Indic
{
	...
	public static function insert_dotted_circles(&$info, $dottedcircle)
	{
		...
		if (isset($info[$idx])) {
			throw new \BitCode\BitFormPro\Dependencies\Mpdf\MpdfException('Unexpected error occurred in Indic processing');
		}

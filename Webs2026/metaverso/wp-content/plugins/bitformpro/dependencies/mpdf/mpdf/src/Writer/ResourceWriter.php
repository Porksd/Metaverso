...
final class ResourceWriter implements \BitCode\BitFormPro\Dependencies\Psr\Log\LoggerAwareInterface
{
	...
	/**
	 * @param \BitCode\BitFormPro\Dependencies\Psr\Log\LoggerInterface $logger
	 *
	 * @return void
	 */

...
namespace BitCode\BitFormPro\Integration\ZohoCampaigns;

use BitCode\BitForm\Core\Util\IpTool;
use BitCode\BitForm\Core\Util\HttpHelper;
use BitCode\BitForm\Core\Integration\IntegrationHandler;
use BitCode\BitFormPro\Integration\ZohoCampaigns\RecordApiHelper;
...
class ZohoCampaignsHandler
{
    ...
    {
        add_action('wp_ajax_bitforms_zcampaigns_generate_token', array(__CLASS__, 'generateTokens'));
        add_action('wp_ajax_bitforms_zcampaigns_refresh_lists', array(__CLASS__, 'refreshListsAjaxHelper'));
        add_action('wp_ajax_bitforms_zcampaigns_refresh_contact_fields', array(__CLASS__, 'refreshContactFieldsAjaxHelper'));
    }
    ...
    public function execute(IntegrationHandler $integrationHandler, $integrationData, $fieldValues, $entryID, $logID)
    {
        ...
        if (
            ...
            $error = new WP_Error('REQ_FIELD_EMPTY', __('list are required for zoho campaigns api', 'bitformpro'));

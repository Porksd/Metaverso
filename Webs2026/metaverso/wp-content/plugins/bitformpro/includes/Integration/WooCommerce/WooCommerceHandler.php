...
class WooCommerceHandler
{
    ...
    public static function authorizeWC()
    {
        if (isset($_REQUEST['_ajax_nonce']) && wp_verify_nonce($_REQUEST['_ajax_nonce'], 'bitforms_save')) {
            ...
            wp_send_json_error(__('WooCommerce must be activated!', 'bitformpro'));
        } else {
            wp_send_json_error(
                __(
                    'Token expired',
    ...
    public function execute(IntegrationHandler $integrationHandler, $integrationData, $fieldValues, $entryID, $logID)
    {
        ...
        if (
            ...
            $error = new WP_Error('REQ_FIELD_EMPTY', __('module and field map are required for woocommerce', 'bitformpro'));

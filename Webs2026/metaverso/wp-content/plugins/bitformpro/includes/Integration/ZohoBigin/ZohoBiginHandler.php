...
use BitCode\BitFormPro\Integration\ZohoBigin\RecordApiHelper;
...
class ZohoBiginHandler
{
    ...
    public function execute(IntegrationHandler $integrationHandler, $integrationData, $fieldValues, $entryID, $logID)
    {
        ...
        if (
            ...
            $error = new WP_Error('REQ_FIELD_EMPTY', __('module, fields are required for zoho bigin api', 'bitformpro'));

...
namespace BitCode\BitFormPro\Integration\ZohoAnalytics;

use WP_Error;
use BitCode\BitForm\Core\Util\IpTool;
use BitCode\BitForm\Core\Util\HttpHelper;
use BitCode\BitForm\Core\Integration\IntegrationHandler;
use BitCode\BitFormPro\Integration\ZohoAnalytics\RecordApiHelper;
...
class ZohoAnalyticsHandler
{
    ...
    {
        add_action('wp_ajax_bitforms_zanalytics_generate_token', array(__CLASS__, 'generateTokens'));
        add_action('wp_ajax_bitforms_zanalytics_refresh_workspaces', array(__CLASS__, 'refreshWorkspacesAjaxHelper'));
        add_action('wp_ajax_bitforms_zanalytics_refresh_users', array(__CLASS__, 'refreshUsersAjaxHelper'));
        add_action('wp_ajax_bitforms_zanalytics_refresh_tables', array(__CLASS__, 'refreshTablesAjaxHelper'));
        add_action('wp_ajax_bitforms_zanalytics_refresh_table_headers', array(__CLASS__, 'refreshTableHeadersAjaxHelper'));
    }
    ...
    public function execute(IntegrationHandler $integrationHandler, $integrationData, $fieldValues, $entryID, $logID)
    {
        ...
        if (
            ...
            $error = new WP_Error('REQ_FIELD_EMPTY', __('workspace, table, fields are required for zoho analytics api', 'bitformpro'));

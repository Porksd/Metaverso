...
class Plugin extends Framework\SV_WC_Plugin {
	...
	/** plugin id */
	public const PLUGIN_ID = 'checkout_add_ons';

	/** plugin meta prefix */
	public const PLUGIN_PREFIX = 'wc_checkout_add_ons_';

	/** @var Plugin single instance of this plugin */
	protected static $instance;

	/** @var Admin|null instance of admin handler */
	private ?Admin $admin = null;

	/** @var Frontend|null instance of frontend handler */
	private ?Frontend $frontend = null;

	/** @var Export_Handler|null instance of export handler */
	private ?Export_Handler $export_handler = null;

	/** @var bool|null if WooCommerce Subscriptions is active */
	private ?bool $subscriptions_active = null;

	/** @var WC_Subscriptions_Integration */
	private WC_Subscriptions_Integration $subscription_integration;
	 ...
	 */
	public function get_export_handler() : ?Export_Handler
	{

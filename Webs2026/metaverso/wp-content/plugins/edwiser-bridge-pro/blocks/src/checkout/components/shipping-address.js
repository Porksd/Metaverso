import { Checkbox, Select, Skeleton, TextInput } from '@mantine/core';
import React, {
  forwardRef,
  useEffect,
  useImperativeHandle,
...
const ShippingAddress = forwardRef(
  (
    ...
    const handleAddressUpdate = async (updatedAddress) => {
      const updatedShippingAddress = { ...shippingAddress, ...updatedAddress };
      let updatedBillingAddress = billingAddress;
    ...
    return (
      <div className="eb-checkout__shipping-address">
        <div className="shipping-address__header">
          <h2 className="shipping-address__title">Shipping address</h2>
        </div>
        <div className="shipping-address__content">
          <div className="shipping-address__col-2">
            <TextInput
              label={
                <>
          ...
          <div
            className={
              states.length > 0
                ? 'shipping-address__col-2'
                : 'shipping-address__col-1'
            }
          >
            <TextInput
              label={
          ...
          <Checkbox
            ...
            onChange={(e) => setSameBillingAddress(e.currentTarget.checked)}
          />
        </div>
      </div>
    );

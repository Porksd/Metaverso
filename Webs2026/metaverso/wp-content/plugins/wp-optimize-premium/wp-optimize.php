...
Requires PHP: 7.2
Update URI: https://teamupdraft.com/wp-optimize/
...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    if ($parsed_args['method'] === 'POST' && strpos($url, 'https://teamupdraft.com/plugin-info/') !== false) {
        $response_array = [
            "version" => 1,
            "code" => "OK",
            "data" => [
                "plugin_info" => [
                    ...
                    "author" => "teamupdraft.com",
                    "homepage" => "https://teamupdraft.com",
                    "sections" => [

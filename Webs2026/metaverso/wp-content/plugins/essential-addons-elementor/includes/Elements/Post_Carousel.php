...
class Post_Carousel extends Widget_Base
{
	...
	protected function render()
	{
		...
		$settings = [
			...
			'eael_post_grid_bg_hover_icon_new' => isset($settings['__fa4_migrated']['eael_post_grid_bg_hover_icon_new']) || !empty( $settings['eael_post_grid_bg_hover_icon_new'] ) ? $settings['eael_post_grid_bg_hover_icon_new'] : ( ! empty($settings['eael_post_grid_bg_hover_icon']) ? $settings['eael_post_grid_bg_hover_icon'] : '' ),

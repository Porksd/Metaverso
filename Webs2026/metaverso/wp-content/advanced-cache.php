...
// WP-Optimize advanced-cache.php (written by version: 4.2.4) (homeurl: https://metaversotec.cl/web/) (abspath: /home/metavers/public_html/web/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/home/metavers/public_html/web/wp-content/plugins/wp-optimize-premium/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('https://metaversotec.cl/web/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/home/metavers/public_html/web/wp-content/plugins/wp-optimize-premium/cache/extensions');
}

if (!@file_exists(WPO_CACHE_CONFIG_DIR . '/config-metaversotec.cl.php')) { return; }

$GLOBALS['wpo_cache_config'] = @json_decode(file_get_contents(WPO_CACHE_CONFIG_DIR . '/config-metaversotec.cl.php'), true);

if (empty($GLOBALS['wpo_cache_config'])) {
	include_once(WPO_CACHE_CONFIG_DIR . '/config-metaversotec.cl.php');
}
